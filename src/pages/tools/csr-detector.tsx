			...
			<div className="mt-4">
				<form>
					...
					<button
						...
						className="mt-4 py-2 px-3 font-semibold text-white bg-primary hover:bg-primary-light text-sm"
					>
						Detect
					</button>
				</form>
				...
				<div className="mt-4">
					{data === "CSR" && (
						<p className="text-green-500">
							This site uses client-side rendering.
						</p>
					)}
					{data === "SSR" && (
					...
					{data === "Unknown" && (
						<p className="text-yellow-500">
							I&apos;m not too sure about this site, but it likely
